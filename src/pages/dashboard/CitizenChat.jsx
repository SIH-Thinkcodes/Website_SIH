        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-800">Police Dashboard</h1>
                {currentUser && (
          ...
          <div className="p-2">
            ...
            {filteredCitizens.length === 0 ? (
              <div className="text-center py-8">
                <Users className="mx-auto text-gray-300 w-12 h-12 mb-3" />
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-xs text-gray-500">{citizen.destination || 'No destination'}</span>
                        </div>
                        <div className="flex items-center space-x-1">
      ...
      <div className="flex-1 flex flex-col">
        {activeChat ? (
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="text-center text-gray-500 mt-8">
                  <MessageCircle className="mx-auto w-12 h-12 mb-2 text-gray-300" />
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <MessageCircle className="mx-auto text-gray-400 w-16 h-16 mb-4" />
